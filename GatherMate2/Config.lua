...
local function showCopyExportFrame(status, text)
...
local exportOptions = {
	...
	args = {
		exportMines = {
			...
			func = function()
				local data = ""
				data = tableToString(GatherMate2MineDB)
				showCopyExportFrame("Exporting Mines", "GatherMateData2MineDB =      "..data)
			end,
		},
		exportHerbs = {
			order = 1,
			...
			func = function()
				local data = ""
				data = tableToString(GatherMate2HerbDB)
				showCopyExportFrame("Exporting Herbs", "GatherMateData2HerbDB =      ".. data)
			end,
		},
		exportGases = {
			order = 1,
			...
			func = function()
				local data = ""
				data = tableToString(GatherMate2GasDB)
				showCopyExportFrame("Exporting Gases", "GatherMateData2GasDB =      ".. data)
			end,
		},
		exportFish = {
			order = 1,
			...
			func = function()
				local data = ""
				data = tableToString(GatherMate2FishDB)
				showCopyExportFrame("Exporting Fish", "GatherMateData2FishDB =      ".. data)
			end,
		},
		exportTreasure = {
			order = 1,
			name = L["Export Treasure"],
			type = "execute",
			func = function()
				local data = ""
				data = tableToString(GatherMate2TreasureDB)
				showCopyExportFrame("Exporting Treasure", "GatherMateData2TreasureDB =      ".. data)
			end,
		},
	},
	get = get,
...
function Config:OnInitialize()
	...
	acr:RegisterOptionsTable("GM2/Export", exportOptions)
	acd:AddToBlizOptions("GM2/Export", "Export", "GatherMate 2")
