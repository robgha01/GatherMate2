...
--]]
local MAJOR, MINOR = "LibMapData-1.0", tonumber("57") or 999
...
do
	...
	-- Just added to stop missing id for ascension, filler zones that can be found if a custom patch is installed
	mapData[0] = {
		['floors'] = 0, ['name'] = "UnkownZone", ['rzti'] = 0, ['map_type'] = 0, ['continent'] = 1, ['transform'] = 0,
		[1] = {3470.83325195312,2314.5830078125,-1535.41662597656,-7939.5830078125,1935.41662597656,-10254.166015625},
	}
	mapData[617] = {
		['floors'] = 0, ['name'] = "SnowdriftPeaks", ['rzti'] = 0, ['map_type'] = 0, ['continent'] = 1, ['transform'] = 0,
		[1] = {3470.83325195312,2314.5830078125,-1535.41662597656,-7939.5830078125,1935.41662597656,-10254.166015625},
	}
	mapData[618] = {
		['floors'] = 0, ['name'] = "Stromgarde", ['rzti'] = 0, ['map_type'] = 0, ['continent'] = 1, ['transform'] = 0,
		[1] = {3470.83325195312,2314.5830078125,-1535.41662597656,-7939.5830078125,1935.41662597656,-10254.166015625},
	}
...
for continent in pairs({GetMapContinents()}) do
	...
	for zone, name in pairs(zones) do
		...
		if area_id ~= aid then
			error(mapFile.." area id mismatch, ".."should be "..area_id)
		end
	end
end
